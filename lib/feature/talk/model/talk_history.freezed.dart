...
mixin _$TalkHistory {
 ...
 String get talkId=> throw _privateConstructorUsedError; String get talkRoomId=> throw _privateConstructorUsedError; String get talkerUserId=> throw _privateConstructorUsedError; List<String> get userIds=> throw _privateConstructorUsedError; bool get isOpened=> throw _privateConstructorUsedError; String get message=> throw _privateConstructorUsedError; String get imageUrl=> throw _privateConstructorUsedError;@TimestampConverter() Timestamp get createdAt=> throw _privateConstructorUsedError;@TimestampConverter() Timestamp get updatedAt=> throw _privateConstructorUsedError;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TalkHistory&&(identical(other.talkId, talkId) || other.talkId == talkId)&&(identical(other.talkRoomId, talkRoomId) || other.talkRoomId == talkRoomId)&&(identical(other.talkerUserId, talkerUserId) || other.talkerUserId == talkerUserId)&&const DeepCollectionEquality().equals(other.userIds, userIds)&&(identical(other.isOpened, isOpened) || other.isOpened == isOpened)&&(identical(other.message, message) || other.message == message)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,talkId,talkRoomId,talkerUserId,const DeepCollectionEquality().hash(userIds),isOpened,message,imageUrl,createdAt,updatedAt);

@override
String toString() {
  return 'TalkHistory(talkId: $talkId, talkRoomId: $talkRoomId, talkerUserId: $talkerUserId, userIds: $userIds, isOpened: $isOpened, message: $message, imageUrl: $imageUrl, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String talkId, String talkRoomId, String talkerUserId, List<String> userIds, bool isOpened, String message, String imageUrl,@TimestampConverter() Timestamp createdAt,@TimestampConverter() Timestamp updatedAt
});
...
/// Create a copy of TalkHistory
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? talkId = null,Object? talkRoomId = null,Object? talkerUserId = null,Object? userIds = null,Object? isOpened = null,Object? message = null,Object? imageUrl = null,Object? createdAt = null,Object? updatedAt = null,}) {
...
class _TalkHistory implements TalkHistory {
   _TalkHistory({required this.talkId, required this.talkRoomId, required this.talkerUserId, required final  List<String> userIds, required this.isOpened, required this.message, required this.imageUrl, @TimestampConverter() required this.createdAt, @TimestampConverter() required this.updatedAt}): _userIds = userIds;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TalkHistory&&(identical(other.talkId, talkId) || other.talkId == talkId)&&(identical(other.talkRoomId, talkRoomId) || other.talkRoomId == talkRoomId)&&(identical(other.talkerUserId, talkerUserId) || other.talkerUserId == talkerUserId)&&const DeepCollectionEquality().equals(other._userIds, _userIds)&&(identical(other.isOpened, isOpened) || other.isOpened == isOpened)&&(identical(other.message, message) || other.message == message)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,talkId,talkRoomId,talkerUserId,const DeepCollectionEquality().hash(_userIds),isOpened,message,imageUrl,createdAt,updatedAt);
...
/// Create a copy of TalkHistory
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? talkId = null,Object? talkRoomId = null,Object? talkerUserId = null,Object? userIds = null,Object? isOpened = null,Object? message = null,Object? imageUrl = null,Object? createdAt = null,Object? updatedAt = null,}) {
