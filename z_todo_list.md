...
- [] マイページのデザイン
    - [] 縦のラインが揃っていない
    - [] 情報の大きさがメリハリない(性別、生年月日、プロフィールはもっと小さくて良いのでは)
- [] 投稿日の日付をyyyy/mm/dd形式に統一する
- [] メッセージ写真、ポスト写真を端末に保存できるよう
- [] ユーザーネームで絵文字12個にしたら文字数オーバーになってしまう
- [] プロフィールめっちゃ改行いれまくっても、マイページには4、5行程度しか表示されない
- [] フォロワー数とフォロワー一覧にズレがある
